...
namespace System.Windows.Media.Interop
{
...
#pragma warning restore 0649
    ...
    interface IImagingFactory
    {
        ...
        uint CreateNewBitmap(int width, int height, PixelFormatID pixelFormat, out IBitmapImage bitmap);
        uint CreateBitmapFromImage(IImage image, int width, int height, PixelFormatID pixelFormat, InterpolationHint hints, out IBitmapImage bitmap);
        uint CreateBitmapFromBuffer(ref BitmapImageData data, out IBitmapImage bitmapImage);
    ...
    {
        uint GetSize(out System.Drawing.Size size);
